...
public class OrderTest {
    ...
    public void bigOrder() {
        ...
        assertEquals("", 98.55, order.getItemPrice(), 0.01);
        // ----------------------------------------------------
        assertEquals("", 1.75, order.getSatisfactionPrice(), 0);
        assertEquals("", 98.55, order.getItemPrice(), 0);
        // -------------------------------------------------------
        assertEquals("", 157.5765, order.calculateFinalPrice(), 0.001);
        order.removeItem(sneak, u1);
        assertEquals("", 1.25, order.getSatisfactionPrice(), 0);
        assertEquals("", 127.869, order.calculateFinalPrice(), 0.0001);
    }
